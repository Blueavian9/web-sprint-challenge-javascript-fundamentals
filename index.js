...
// A nested function can access other local functions, variables, 
// constants, types, classes, etc. that are in the same scope,
// or in any enclosing scope, without an explicit parameter passing,
// which greatly simplifies passing data into and out of the nested function.
...
const zooAnimals = [
  ...
  */
  function animalNames(zooAnimals) {
    ...
    zooAnimals.forEach((element) => {
      displayAnimals.push('name: ' + element.animal_name + ', scientific: ' + element.scientific_name);
    });
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
    const arrLower = zooAnimals.map((element) => element.animal_name.toLowerCase());
    return arrLower;
  }
  ...
  */
  function lowPopulationAnimals(zooAnimals) {
    const newarr = zooAnimals.filter((element) => element.population < 5);
    return newarr;
  }
  ...
  */
  function USApop(zooAnimals) {
    const onlyNum = zooAnimals.map((element) => element.population);
    const zooSum = onlyNum.reduce((accumulator, currentValue) => {
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
 ...
 console.log(consume("Mary", "Poppins", greeting));  // "Hello Mary Poppins",
 "nice to meet you!"
